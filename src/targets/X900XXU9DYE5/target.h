...
#define BUILD_VARIANT_LABEL "gts8uwifi_taro_v5.10"
#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT "samsung/gts8uwifieea/gts8uwifi:15/AP3A.240905.015.A2/X900XXU9DYE5:user/release-keys"
#endif
...
#define ASHMEM_MISC_FOPS_OFF 0x026db228ULL   /* &ashmem_misc.fops */
#define ASHMEM_FOPS_OFF      0x02076960ULL   /* &ashmem_fops           */

/* Function addresses (raw entry points) */
#define ASHMEM_IOCTL_OFF         0x01110f90ULL   /* ashmem_ioctl           */
#define ASHMEM_COMPAT_IOCTL_OFF  0x01111a5cULL   /* compat_ashmem_ioctl    */
#define ASHMEM_MMAP_OFF          0x01111ab4ULL   /* ashmem_mmap            */
#define ASHMEM_OPEN_OFF          0x01111ce4ULL   /* ashmem_open            */
#define ASHMEM_RELEASE_OFF       0x01111d7cULL   /* ashmem_release         */
#define ASHMEM_SHOW_FDINFO_OFF   0x01111e98ULL   /* ashmem_show_fdinfo     */
...
#define KMALLOC_CACHES_OFF      0x020b8880ULL   /* kmalloc_caches      */
#define ANON_PIPE_BUF_OPS_OFF   0x01ef9fa8ULL   /* anon_pipe_buf_ops   */
...
#define ASHMEM_IOCTL_JT_OFF           0x01110f90ULL   /* -> ashmem_ioctl            */
#define ASHMEM_COMPAT_IOCTL_JT_OFF    0x01111a5cULL   /* -> compat_ashmem_ioctl     */
#define ASHMEM_MMAP_JT_OFF            0x01111ab4ULL   /* -> ashmem_mmap             */
#define ASHMEM_OPEN_JT_OFF            0x01111ce4ULL   /* -> ashmem_open             */
#define ASHMEM_RELEASE_JT_OFF         0x01111d7cULL   /* -> ashmem_release          */
#define ASHMEM_SHOW_FDINFO_JT_OFF     0x01111e98ULL   /* -> ashmem_show_fdinfo      */
#define ASHMEM_LLSEEK_JT_OFF          0x01110df0ULL   /* real table .llseek (ashmem_llseek) */
...
#define SLIDE_NFULNL_LOGGER_OFF        0x02581338ULL
#define SLIDE_LOGGERS_0_1_OFF          0x02581268ULL   /* &loggers[0][1] */
#define SLIDE_RANDOM_BOOT_ID_DATA_OFF  0x0269b128ULL   /* &random_table[4].data */
#define SLIDE_INIT_TASK_OFF            INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF      ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF        0x0295bb45ULL   /* sysctl_bootid buffer */
