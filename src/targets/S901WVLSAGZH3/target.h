...
#define ASHMEM_FOPS_OFF      0x02081238ULL   /* &ashmem_fops           */
...
#define KMALLOC_CACHES_OFF      0x020c3420ULL   /* kmalloc_caches      */
#define ANON_PIPE_BUF_OPS_OFF   0x01f03ea8ULL   /* anon_pipe_buf_ops   */
